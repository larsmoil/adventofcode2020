...
pub fn parse(input: String) -> Vec<Vec<char>> {
    input.split("\n\n").map(|group| {
        let answers: HashSet<char> = group
            ...
            .drain(..)
            .collect();
        let mut answers = answers.into_iter().collect::<Vec<char>>();
        answers.sort();
        answers
    }).collect::<Vec<Vec<char>>>()
}
pub fn parse_pt2(input: String) -> Vec<Vec<char>> {
    input.split("\n\n").map(|group| {
        let alphabet = "abcdefghijklmnopqrstuvwxyz".chars().collect();
        let answers: Vec<char> = group.split("\n")
...
pub fn pt1(input: String) -> usize {
    parse(input).iter().fold(0, |a, b| a + b.len())
}

pub fn pt2(input: String) -> usize {
    parse_pt2(input).iter().fold(0, |a, b| a + b.len())
}
...
b".to_string()
    ...
    #[test]
    fn test_parse() {
        assert_eq!(parse(example_input()), vec![
            vec!['a', 'b', 'c'],
            vec!['a', 'b', 'c'],
            vec!['a', 'b', 'c'],
            vec!['a'],
    ...
    #[test]
    fn test_parse_pt2() {
        assert_eq!(parse_pt2(example_input()), vec![
            vec!['a', 'b', 'c'],
            vec![],
            vec!['a'],
            vec!['a'],
    ...
    #[test]
    fn test_pt1_example() {
        assert_eq!(pt1(example_input()), 11);
    }

    #[test]
    fn test_pt1() {
        assert_eq!(pt1(input()), 6551);
    }

    #[test]
    fn test_pt2_example() {
        assert_eq!(pt2(example_input()), 6);
    }

    #[test]
    fn test_pt2() {
        assert_eq!(pt2(input()), 3358);
    }
}
